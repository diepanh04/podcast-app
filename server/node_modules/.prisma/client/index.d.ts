...
/**
   ...
   * `prisma.favouriteList`: Exposes CRUD operations for the **FavouriteList** model.
    ...
    * ```
    */
  get favouriteList(): Prisma.FavouriteListDelegate<GlobalReject>;

  /**
   * `prisma.favouriteChannel`: Exposes CRUD operations for the **FavouriteChannel** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more FavouriteChannels
    * const favouriteChannels = await prisma.favouriteChannel.findMany()
    * ```
    */
  get favouriteChannel(): Prisma.FavouriteChannelDelegate<GlobalReject>;

  /**
   * `prisma.favouriteEpisode`: Exposes CRUD operations for the **FavouriteEpisode** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more FavouriteEpisodes
    * const favouriteEpisodes = await prisma.favouriteEpisode.findMany()
    * ```
    */
  get favouriteEpisode(): Prisma.FavouriteEpisodeDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
   ...
   * UserCountOutputType without action
   */
  export type UserCountOutputTypeCountHeartsArgs = {
  ...
  export type GenreCountOutputTypeSelect = {
    channels?: boolean | GenreCountOutputTypeCountChannelsArgs
  }
   ...
   * GenreCountOutputType without action
   */
  export type GenreCountOutputTypeCountChannelsArgs = {
  ...
  export type ChannelCountOutputType = {
    ...
    favouriteChannels: number
  }

  export type ChannelCountOutputTypeSelect = {
    genres?: boolean | ChannelCountOutputTypeCountGenresArgs
    episodes?: boolean | ChannelCountOutputTypeCountEpisodesArgs
    channelHearts?: boolean | ChannelCountOutputTypeCountChannelHeartsArgs
    favouriteChannels?: boolean | ChannelCountOutputTypeCountFavouriteChannelsArgs
  }
   ...
   * ChannelCountOutputType without action
   */
  export type ChannelCountOutputTypeCountGenresArgs = {
    where?: GenresOnChannelsWhereInput
  }
   ...
   * ChannelCountOutputType without action
   */
  export type ChannelCountOutputTypeCountEpisodesArgs = {
   ...
   * ChannelCountOutputType without action
   */
  export type ChannelCountOutputTypeCountChannelHeartsArgs = {
   ...
   * ChannelCountOutputType without action
   */
  export type ChannelCountOutputTypeCountFavouriteChannelsArgs = {
    where?: FavouriteChannelWhereInput
  }
  ...
  export type EpisodeCountOutputTypeSelect = {
    episodeHearts?: boolean | EpisodeCountOutputTypeCountEpisodeHeartsArgs
    favouriteEpisodes?: boolean | EpisodeCountOutputTypeCountFavouriteEpisodesArgs
  }
   ...
   * EpisodeCountOutputType without action
   */
  export type EpisodeCountOutputTypeCountEpisodeHeartsArgs = {
   ...
   * EpisodeCountOutputType without action
   */
  export type EpisodeCountOutputTypeCountFavouriteEpisodesArgs = {
    where?: FavouriteEpisodeWhereInput
  }
  ...
  export type HeartCountOutputTypeSelect = {
    channelHearts?: boolean | HeartCountOutputTypeCountChannelHeartsArgs
    episodeHearts?: boolean | HeartCountOutputTypeCountEpisodeHeartsArgs
  }
   ...
   * HeartCountOutputType without action
   */
  export type HeartCountOutputTypeCountChannelHeartsArgs = {
    where?: ChannelHeartWhereInput
  }
   ...
   * HeartCountOutputType without action
   */
  export type HeartCountOutputTypeCountEpisodeHeartsArgs = {
    where?: EpisodeHeartWhereInput
  }
  ...
  /**
   * Count Type FavouriteListCountOutputType
   */


  export type FavouriteListCountOutputType = {
    favouriteChannels: number
    favouriteEpisodes: number
  }

  export type FavouriteListCountOutputTypeSelect = {
    favouriteChannels?: boolean | FavouriteListCountOutputTypeCountFavouriteChannelsArgs
    favouriteEpisodes?: boolean | FavouriteListCountOutputTypeCountFavouriteEpisodesArgs
  }

  export type FavouriteListCountOutputTypeGetPayload<S extends boolean | null | undefined | FavouriteListCountOutputTypeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? FavouriteListCountOutputType :
    S extends undefined ? never :
    S extends { include: any } & (FavouriteListCountOutputTypeArgs)
    ? FavouriteListCountOutputType 
    : S extends { select: any } & (FavouriteListCountOutputTypeArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof FavouriteListCountOutputType ? FavouriteListCountOutputType[P] : never
  } 
      : FavouriteListCountOutputType
  ...
  /**
   * FavouriteListCountOutputType without action
   */
  export type FavouriteListCountOutputTypeArgs = {
    /**
     * Select specific fields to fetch from the FavouriteListCountOutputType
     */
    select?: FavouriteListCountOutputTypeSelect | null
  }
   ...
   * FavouriteListCountOutputType without action
   */
  export type FavouriteListCountOutputTypeCountFavouriteChannelsArgs = {
    where?: FavouriteChannelWhereInput
  }
   ...
   * FavouriteListCountOutputType without action
   */
  export type FavouriteListCountOutputTypeCountFavouriteEpisodesArgs = {
    where?: FavouriteEpisodeWhereInput
  }
  ...
  export type UserSelect = {
    ...
    favouriteList?: boolean | FavouriteListArgs
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'favouriteList' ? FavouriteListGetPayload<S['include'][P]> | null :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'favouriteList' ? FavouriteListGetPayload<S['select'][P]> | null :
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    favouriteList<T extends FavouriteListArgs= {}>(args?: Subset<T, FavouriteListArgs>): Prisma__FavouriteListClient<FavouriteListGetPayload<T> | Null>;
  ...
  export type ChannelSelect = {
    ...
    favouriteChannels?: boolean | Channel$favouriteChannelsArgs
  ...
  export type ChannelGetPayload<S extends boolean | null | undefined | ChannelArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'favouriteChannels' ? Array < FavouriteChannelGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'favouriteChannels' ? Array < FavouriteChannelGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__ChannelClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    favouriteChannels<T extends Channel$favouriteChannelsArgs= {}>(args?: Subset<T, Channel$favouriteChannelsArgs>): Prisma.PrismaPromise<Array<FavouriteChannelGetPayload<T>>| Null>;
  ...
  /**
   * Channel.favouriteChannels
   */
  export type Channel$favouriteChannelsArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: FavouriteChannelInclude | null
    where?: FavouriteChannelWhereInput
    orderBy?: Enumerable<FavouriteChannelOrderByWithRelationInput>
    cursor?: FavouriteChannelWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<FavouriteChannelScalarFieldEnum>
  }
  ...
  export type EpisodeSelect = {
    ...
    favouriteEpisodes?: boolean | Episode$favouriteEpisodesArgs
  ...
  export type EpisodeGetPayload<S extends boolean | null | undefined | EpisodeArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'favouriteEpisodes' ? Array < FavouriteEpisodeGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'favouriteEpisodes' ? Array < FavouriteEpisodeGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__EpisodeClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    favouriteEpisodes<T extends Episode$favouriteEpisodesArgs= {}>(args?: Subset<T, Episode$favouriteEpisodesArgs>): Prisma.PrismaPromise<Array<FavouriteEpisodeGetPayload<T>>| Null>;
  ...
  /**
   * Episode.favouriteEpisodes
   */
  export type Episode$favouriteEpisodesArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: FavouriteEpisodeInclude | null
    where?: FavouriteEpisodeWhereInput
    orderBy?: Enumerable<FavouriteEpisodeOrderByWithRelationInput>
    cursor?: FavouriteEpisodeWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<FavouriteEpisodeScalarFieldEnum>
  }
  ...
  export type FavouriteListAggregateArgs = {
    /**
     ...
     */
    orderBy?: Enumerable<FavouriteListOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type FavouriteListGroupByArgs = {
    where?: FavouriteListWhereInput
    orderBy?: Enumerable<FavouriteListOrderByWithAggregationInput>
    by: FavouriteListScalarFieldEnum[]
  ...
  type GetFavouriteListGroupByPayload<T extends FavouriteListGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<FavouriteListGroupByOutputType, T['by']> &
        {
  ...
  export type FavouriteListSelect = {
    id?: boolean
    userId?: boolean
    user?: boolean | UserArgs
    favouriteChannels?: boolean | FavouriteList$favouriteChannelsArgs
    favouriteEpisodes?: boolean | FavouriteList$favouriteEpisodesArgs
    _count?: boolean | FavouriteListCountOutputTypeArgs
  }


  export type FavouriteListInclude = {
    user?: boolean | UserArgs
    favouriteChannels?: boolean | FavouriteList$favouriteChannelsArgs
    favouriteEpisodes?: boolean | FavouriteList$favouriteEpisodesArgs
    _count?: boolean | FavouriteListCountOutputTypeArgs
  ...
  export type FavouriteListGetPayload<S extends boolean | null | undefined | FavouriteListArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? FavouriteList :
    S extends undefined ? never :
    S extends { include: any } & (FavouriteListArgs | FavouriteListFindManyArgs)
    ? FavouriteList  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'user' ? UserGetPayload<S['include'][P]> :
        P extends 'favouriteChannels' ? Array < FavouriteChannelGetPayload<S['include'][P]>>  :
        P extends 'favouriteEpisodes' ? Array < FavouriteEpisodeGetPayload<S['include'][P]>>  :
        P extends '_count' ? FavouriteListCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (FavouriteListArgs | FavouriteListFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :
        P extends 'favouriteChannels' ? Array < FavouriteChannelGetPayload<S['select'][P]>>  :
        P extends 'favouriteEpisodes' ? Array < FavouriteEpisodeGetPayload<S['select'][P]>>  :
        P extends '_count' ? FavouriteListCountOutputTypeGetPayload<S['select'][P]> :  P extends keyof FavouriteList ? FavouriteList[P] : never
  } 
      : FavouriteList


  type FavouriteListCountArgs = 
    Omit<FavouriteListFindManyArgs, 'select' | 'include'> & {
      select?: FavouriteListCountAggregateInputType | true
    }

  export interface FavouriteListDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends FavouriteListFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, FavouriteListFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'FavouriteList'> extends True ? Prisma__FavouriteListClient<FavouriteListGetPayload<T>> : Prisma__FavouriteListClient<FavouriteListGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends FavouriteListFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, FavouriteListFindUniqueOrThrowArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends FavouriteListFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, FavouriteListFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'FavouriteList'> extends True ? Prisma__FavouriteListClient<FavouriteListGetPayload<T>> : Prisma__FavouriteListClient<FavouriteListGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends FavouriteListFindFirstOrThrowArgs>(
      args?: SelectSubset<T, FavouriteListFindFirstOrThrowArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends FavouriteListFindManyArgs>(
      args?: SelectSubset<T, FavouriteListFindManyArgs>
    ): Prisma.PrismaPromise<Array<FavouriteListGetPayload<T>>>
     ...
     * 
    **/
    create<T extends FavouriteListCreateArgs>(
      args: SelectSubset<T, FavouriteListCreateArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends FavouriteListCreateManyArgs>(
      args?: SelectSubset<T, FavouriteListCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends FavouriteListDeleteArgs>(
      args: SelectSubset<T, FavouriteListDeleteArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
     ...
     * 
    **/
    update<T extends FavouriteListUpdateArgs>(
      args: SelectSubset<T, FavouriteListUpdateArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends FavouriteListDeleteManyArgs>(
      args?: SelectSubset<T, FavouriteListDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends FavouriteListUpdateManyArgs>(
      args: SelectSubset<T, FavouriteListUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends FavouriteListUpsertArgs>(
      args: SelectSubset<T, FavouriteListUpsertArgs>
    ): Prisma__FavouriteListClient<FavouriteListGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FavouriteListClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    favouriteChannels<T extends FavouriteList$favouriteChannelsArgs= {}>(args?: Subset<T, FavouriteList$favouriteChannelsArgs>): Prisma.PrismaPromise<Array<FavouriteChannelGetPayload<T>>| Null>;

    favouriteEpisodes<T extends FavouriteList$favouriteEpisodesArgs= {}>(args?: Subset<T, FavouriteList$favouriteEpisodesArgs>): Prisma.PrismaPromise<Array<FavouriteEpisodeGetPayload<T>>| Null>;
  ...
  /**
   * FavouriteList base type for findUnique actions
   */
  export type FavouriteListFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: FavouriteListInclude | null
    /**
   ...
   */
  export interface FavouriteListFindUniqueArgs extends FavouriteListFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type FavouriteListFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
  ...
  /**
   * FavouriteList base type for findFirst actions
   */
  export type FavouriteListFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
     ...
     */
    distinct?: Enumerable<FavouriteListScalarFieldEnum>
  }

  /**
   * FavouriteList findFirst
   */
  export interface FavouriteListFindFirstArgs extends FavouriteListFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type FavouriteListFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListFindManyArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListCreateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListCreateManyArgs = {
    /**
     * The data used to create many FavouriteLists.
     */
    data: Enumerable<FavouriteListCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   */
  export type FavouriteListUpdateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListUpdateManyArgs = {
    /**
   ...
   */
  export type FavouriteListUpsertArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListDeleteArgs = {
    /**
     * Select specific fields to fetch from the FavouriteList
     */
    select?: FavouriteListSelect | null
   ...
   */
  export type FavouriteListDeleteManyArgs = {
    /**
  ...
  /**
   * FavouriteList.favouriteChannels
   */
  export type FavouriteList$favouriteChannelsArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
  ...
  /**
   * FavouriteList.favouriteEpisodes
   */
  export type FavouriteList$favouriteEpisodesArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
  ...
  export type AggregateFavouriteChannel = {
    _count: FavouriteChannelCountAggregateOutputType | null
    _min: FavouriteChannelMinAggregateOutputType | null
    _max: FavouriteChannelMaxAggregateOutputType | null
  }

  export type FavouriteChannelMinAggregateOutputType = {
    id: string | null
    channelId: string | null
    favouriteListId: string | null
  }

  export type FavouriteChannelMaxAggregateOutputType = {
    id: string | null
    channelId: string | null
    favouriteListId: string | null
  }

  export type FavouriteChannelCountAggregateOutputType = {
    id: number
    channelId: number
  ...
  export type FavouriteChannelMinAggregateInputType = {
    id?: true
    channelId?: true
    favouriteListId?: true
  }

  export type FavouriteChannelMaxAggregateInputType = {
    id?: true
    channelId?: true
    favouriteListId?: true
  }

  export type FavouriteChannelCountAggregateInputType = {
    id?: true
    channelId?: true
    favouriteListId?: true
    _all?: true
  ...
  export type FavouriteChannelAggregateArgs = {
    /**
     * Filter which FavouriteChannel to aggregate.
     */
    where?: FavouriteChannelWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of FavouriteChannels to fetch.
     */
    orderBy?: Enumerable<FavouriteChannelOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` FavouriteChannels from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` FavouriteChannels.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned FavouriteChannels
    **/
    _count?: true | FavouriteChannelCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: FavouriteChannelMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: FavouriteChannelMaxAggregateInputType
  }

  export type GetFavouriteChannelAggregateType<T extends FavouriteChannelAggregateArgs> = {
        [P in keyof T & keyof AggregateFavouriteChannel]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateFavouriteChannel[P]>
      : GetScalarType<T[P], AggregateFavouriteChannel[P]>
  }
  ...
  export type FavouriteChannelGroupByArgs = {
    where?: FavouriteChannelWhereInput
    orderBy?: Enumerable<FavouriteChannelOrderByWithAggregationInput>
    by: FavouriteChannelScalarFieldEnum[]
    having?: FavouriteChannelScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: FavouriteChannelCountAggregateInputType | true
    _min?: FavouriteChannelMinAggregateInputType
    _max?: FavouriteChannelMaxAggregateInputType
  }


  export type FavouriteChannelGroupByOutputType = {
    id: string
    channelId: string
    favouriteListId: string
    _count: FavouriteChannelCountAggregateOutputType | null
  ...
  type GetFavouriteChannelGroupByPayload<T extends FavouriteChannelGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<FavouriteChannelGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof FavouriteChannelGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], FavouriteChannelGroupByOutputType[P]>
            : GetScalarType<T[P], FavouriteChannelGroupByOutputType[P]>
        }
      >
    >
  ...
  export type FavouriteChannelSelect = {
    id?: boolean
    channelId?: boolean
    favouriteListId?: boolean
    channel?: boolean | ChannelArgs
    favouriteList?: boolean | FavouriteListArgs
  }


  export type FavouriteChannelInclude = {
    channel?: boolean | ChannelArgs
    favouriteList?: boolean | FavouriteListArgs
  }

  export type FavouriteChannelGetPayload<S extends boolean | null | undefined | FavouriteChannelArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? FavouriteChannel :
    S extends undefined ? never :
    S extends { include: any } & (FavouriteChannelArgs | FavouriteChannelFindManyArgs)
    ? FavouriteChannel  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'channel' ? ChannelGetPayload<S['include'][P]> :
        P extends 'favouriteList' ? FavouriteListGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (FavouriteChannelArgs | FavouriteChannelFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'channel' ? ChannelGetPayload<S['select'][P]> :
        P extends 'favouriteList' ? FavouriteListGetPayload<S['select'][P]> :  P extends keyof FavouriteChannel ? FavouriteChannel[P] : never
  } 
      : FavouriteChannel


  type FavouriteChannelCountArgs = 
    Omit<FavouriteChannelFindManyArgs, 'select' | 'include'> & {
      select?: FavouriteChannelCountAggregateInputType | true
    }

  export interface FavouriteChannelDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one FavouriteChannel that matches the filter.
     * @param {FavouriteChannelFindUniqueArgs} args - Arguments to find a FavouriteChannel
     * @example
     * // Get one FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends FavouriteChannelFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, FavouriteChannelFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'FavouriteChannel'> extends True ? Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>> : Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T> | null, null>

    /**
     * Find one FavouriteChannel that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {FavouriteChannelFindUniqueOrThrowArgs} args - Arguments to find a FavouriteChannel
     * @example
     * // Get one FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends FavouriteChannelFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, FavouriteChannelFindUniqueOrThrowArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Find the first FavouriteChannel that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelFindFirstArgs} args - Arguments to find a FavouriteChannel
     * @example
     * // Get one FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends FavouriteChannelFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, FavouriteChannelFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'FavouriteChannel'> extends True ? Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>> : Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T> | null, null>

    /**
     * Find the first FavouriteChannel that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelFindFirstOrThrowArgs} args - Arguments to find a FavouriteChannel
     * @example
     * // Get one FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends FavouriteChannelFindFirstOrThrowArgs>(
      args?: SelectSubset<T, FavouriteChannelFindFirstOrThrowArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Find zero or more FavouriteChannels that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all FavouriteChannels
     * const favouriteChannels = await prisma.favouriteChannel.findMany()
     * 
     * // Get first 10 FavouriteChannels
     * const favouriteChannels = await prisma.favouriteChannel.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const favouriteChannelWithIdOnly = await prisma.favouriteChannel.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends FavouriteChannelFindManyArgs>(
      args?: SelectSubset<T, FavouriteChannelFindManyArgs>
    ): Prisma.PrismaPromise<Array<FavouriteChannelGetPayload<T>>>

    /**
     * Create a FavouriteChannel.
     * @param {FavouriteChannelCreateArgs} args - Arguments to create a FavouriteChannel.
     * @example
     * // Create one FavouriteChannel
     * const FavouriteChannel = await prisma.favouriteChannel.create({
     *   data: {
     *     // ... data to create a FavouriteChannel
     *   }
     * })
     * 
    **/
    create<T extends FavouriteChannelCreateArgs>(
      args: SelectSubset<T, FavouriteChannelCreateArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Create many FavouriteChannels.
     *     @param {FavouriteChannelCreateManyArgs} args - Arguments to create many FavouriteChannels.
     *     @example
     *     // Create many FavouriteChannels
     *     const favouriteChannel = await prisma.favouriteChannel.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends FavouriteChannelCreateManyArgs>(
      args?: SelectSubset<T, FavouriteChannelCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Delete a FavouriteChannel.
     * @param {FavouriteChannelDeleteArgs} args - Arguments to delete one FavouriteChannel.
     * @example
     * // Delete one FavouriteChannel
     * const FavouriteChannel = await prisma.favouriteChannel.delete({
     *   where: {
     *     // ... filter to delete one FavouriteChannel
     *   }
     * })
     * 
    **/
    delete<T extends FavouriteChannelDeleteArgs>(
      args: SelectSubset<T, FavouriteChannelDeleteArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Update one FavouriteChannel.
     * @param {FavouriteChannelUpdateArgs} args - Arguments to update one FavouriteChannel.
     * @example
     * // Update one FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends FavouriteChannelUpdateArgs>(
      args: SelectSubset<T, FavouriteChannelUpdateArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Delete zero or more FavouriteChannels.
     * @param {FavouriteChannelDeleteManyArgs} args - Arguments to filter FavouriteChannels to delete.
     * @example
     * // Delete a few FavouriteChannels
     * const { count } = await prisma.favouriteChannel.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends FavouriteChannelDeleteManyArgs>(
      args?: SelectSubset<T, FavouriteChannelDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Update zero or more FavouriteChannels.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many FavouriteChannels
     * const favouriteChannel = await prisma.favouriteChannel.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends FavouriteChannelUpdateManyArgs>(
      args: SelectSubset<T, FavouriteChannelUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Create or update one FavouriteChannel.
     * @param {FavouriteChannelUpsertArgs} args - Arguments to update or create a FavouriteChannel.
     * @example
     * // Update or create a FavouriteChannel
     * const favouriteChannel = await prisma.favouriteChannel.upsert({
     *   create: {
     *     // ... data to create a FavouriteChannel
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the FavouriteChannel we want to update
     *   }
     * })
    **/
    upsert<T extends FavouriteChannelUpsertArgs>(
      args: SelectSubset<T, FavouriteChannelUpsertArgs>
    ): Prisma__FavouriteChannelClient<FavouriteChannelGetPayload<T>>

    /**
     * Count the number of FavouriteChannels.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelCountArgs} args - Arguments to filter FavouriteChannels to count.
     * @example
     * // Count the number of FavouriteChannels
     * const count = await prisma.favouriteChannel.count({
     *   where: {
     *     // ... the filter for the FavouriteChannels we want to count
     *   }
     * })
    **/
    count<T extends FavouriteChannelCountArgs>(
      args?: Subset<T, FavouriteChannelCountArgs>,
    ): Prisma.PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], FavouriteChannelCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a FavouriteChannel.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends FavouriteChannelAggregateArgs>(args: Subset<T, FavouriteChannelAggregateArgs>): Prisma.PrismaPromise<GetFavouriteChannelAggregateType<T>>

    /**
     * Group by FavouriteChannel.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteChannelGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends FavouriteChannelGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: FavouriteChannelGroupByArgs['orderBy'] }
        : { orderBy?: FavouriteChannelGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, FavouriteChannelGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFavouriteChannelGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for FavouriteChannel.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FavouriteChannelClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  /**
   * FavouriteChannel base type for findUnique actions
   */
  export type FavouriteChannelFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * Filter, which FavouriteChannel to fetch.
     */
    where: FavouriteChannelWhereUniqueInput
  }

  /**
   * FavouriteChannel findUnique
   */
  export interface FavouriteChannelFindUniqueArgs extends FavouriteChannelFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * FavouriteChannel findUniqueOrThrow
   */
  export type FavouriteChannelFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
  ...
  /**
   * FavouriteChannel base type for findFirst actions
   */
  export type FavouriteChannelFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for FavouriteChannels.
     */
    cursor?: FavouriteChannelWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of FavouriteChannels.
     */
    distinct?: Enumerable<FavouriteChannelScalarFieldEnum>
  }

  /**
   * FavouriteChannel findFirst
   */
  export interface FavouriteChannelFindFirstArgs extends FavouriteChannelFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * FavouriteChannel findFirstOrThrow
   */
  export type FavouriteChannelFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
  ...
  /**
   * FavouriteChannel findMany
   */
  export type FavouriteChannelFindManyArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * Filter, which FavouriteChannels to fetch.
     */
    where?: FavouriteChannelWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing FavouriteChannels.
     */
    cursor?: FavouriteChannelWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
  ...
  /**
   * FavouriteChannel create
   */
  export type FavouriteChannelCreateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * The data needed to create a FavouriteChannel.
     */
    data: XOR<FavouriteChannelCreateInput, FavouriteChannelUncheckedCreateInput>
  }


  /**
   * FavouriteChannel createMany
   */
  export type FavouriteChannelCreateManyArgs = {
    /**
     * The data used to create many FavouriteChannels.
     */
    data: Enumerable<FavouriteChannelCreateManyInput>
    skipDuplicates?: boolean
  }


  /**
   * FavouriteChannel update
   */
  export type FavouriteChannelUpdateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * The data needed to update a FavouriteChannel.
     */
    data: XOR<FavouriteChannelUpdateInput, FavouriteChannelUncheckedUpdateInput>
    /**
     * Choose, which FavouriteChannel to update.
     */
    where: FavouriteChannelWhereUniqueInput
  }
  ...
  /**
   * FavouriteChannel updateMany
   */
  export type FavouriteChannelUpdateManyArgs = {
    /**
     * The data used to update FavouriteChannels.
     */
    data: XOR<FavouriteChannelUpdateManyMutationInput, FavouriteChannelUncheckedUpdateManyInput>
    /**
     * Filter which FavouriteChannels to update
     */
    where?: FavouriteChannelWhereInput
  }
  ...
  /**
   * FavouriteChannel upsert
   */
  export type FavouriteChannelUpsertArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * The filter to search for the FavouriteChannel to update in case it exists.
     */
    where: FavouriteChannelWhereUniqueInput
    /**
     * In case the FavouriteChannel found by the `where` argument doesn't exist, create a new FavouriteChannel with this data.
     */
    create: XOR<FavouriteChannelCreateInput, FavouriteChannelUncheckedCreateInput>
    /**
     * In case the FavouriteChannel was found with the provided `where` argument, update it with this data.
     */
    update: XOR<FavouriteChannelUpdateInput, FavouriteChannelUncheckedUpdateInput>
  }


  /**
   * FavouriteChannel delete
   */
  export type FavouriteChannelDeleteArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
    ...
    include?: FavouriteChannelInclude | null
    /**
     * Filter which FavouriteChannel to delete.
     */
    where: FavouriteChannelWhereUniqueInput
  }
  ...
  /**
   * FavouriteChannel deleteMany
   */
  export type FavouriteChannelDeleteManyArgs = {
    /**
     * Filter which FavouriteChannels to delete
     */
    where?: FavouriteChannelWhereInput
  }
  ...
  /**
   * FavouriteChannel without action
   */
  export type FavouriteChannelArgs = {
    /**
     * Select specific fields to fetch from the FavouriteChannel
     */
    select?: FavouriteChannelSelect | null
  ...
  export type AggregateFavouriteEpisode = {
    _count: FavouriteEpisodeCountAggregateOutputType | null
    _min: FavouriteEpisodeMinAggregateOutputType | null
    _max: FavouriteEpisodeMaxAggregateOutputType | null
  }

  export type FavouriteEpisodeMinAggregateOutputType = {
    id: string | null
    episodeId: string | null
    favouriteListId: string | null
  }

  export type FavouriteEpisodeMaxAggregateOutputType = {
    id: string | null
    episodeId: string | null
    favouriteListId: string | null
  }

  export type FavouriteEpisodeCountAggregateOutputType = {
    id: number
    episodeId: number
    favouriteListId: number
    _all: number
  ...
  export type FavouriteEpisodeMinAggregateInputType = {
    id?: true
    episodeId?: true
    favouriteListId?: true
  }

  export type FavouriteEpisodeMaxAggregateInputType = {
    id?: true
    episodeId?: true
    favouriteListId?: true
  }

  export type FavouriteEpisodeCountAggregateInputType = {
    id?: true
    episodeId?: true
    favouriteListId?: true
    _all?: true
  ...
  export type FavouriteEpisodeAggregateArgs = {
    /**
     * Filter which FavouriteEpisode to aggregate.
     */
    where?: FavouriteEpisodeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of FavouriteEpisodes to fetch.
     */
    orderBy?: Enumerable<FavouriteEpisodeOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` FavouriteEpisodes from the position of the cursor.
     */
    take?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Skip the first `n` FavouriteEpisodes.
     */
    skip?: number
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Count returned FavouriteEpisodes
    **/
    _count?: true | FavouriteEpisodeCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: FavouriteEpisodeMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: FavouriteEpisodeMaxAggregateInputType
  }

  export type GetFavouriteEpisodeAggregateType<T extends FavouriteEpisodeAggregateArgs> = {
        [P in keyof T & keyof AggregateFavouriteEpisode]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateFavouriteEpisode[P]>
      : GetScalarType<T[P], AggregateFavouriteEpisode[P]>
  }
  ...
  export type FavouriteEpisodeGroupByArgs = {
    where?: FavouriteEpisodeWhereInput
    orderBy?: Enumerable<FavouriteEpisodeOrderByWithAggregationInput>
    by: FavouriteEpisodeScalarFieldEnum[]
    having?: FavouriteEpisodeScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: FavouriteEpisodeCountAggregateInputType | true
    _min?: FavouriteEpisodeMinAggregateInputType
    _max?: FavouriteEpisodeMaxAggregateInputType
  }


  export type FavouriteEpisodeGroupByOutputType = {
    id: string
    episodeId: string
    favouriteListId: string
    _count: FavouriteEpisodeCountAggregateOutputType | null
  ...
  type GetFavouriteEpisodeGroupByPayload<T extends FavouriteEpisodeGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<FavouriteEpisodeGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof FavouriteEpisodeGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], FavouriteEpisodeGroupByOutputType[P]>
            : GetScalarType<T[P], FavouriteEpisodeGroupByOutputType[P]>
        }
      >
    >
  ...
  export type FavouriteEpisodeSelect = {
    id?: boolean
    episodeId?: boolean
    favouriteListId?: boolean
    episode?: boolean | EpisodeArgs
  ...
  export type FavouriteEpisodeInclude = {
    episode?: boolean | EpisodeArgs
    favouriteList?: boolean | FavouriteListArgs
  }

  export type FavouriteEpisodeGetPayload<S extends boolean | null | undefined | FavouriteEpisodeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? FavouriteEpisode :
    S extends undefined ? never :
    S extends { include: any } & (FavouriteEpisodeArgs | FavouriteEpisodeFindManyArgs)
    ? FavouriteEpisode  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'episode' ? EpisodeGetPayload<S['include'][P]> :
        P extends 'favouriteList' ? FavouriteListGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (FavouriteEpisodeArgs | FavouriteEpisodeFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'episode' ? EpisodeGetPayload<S['select'][P]> :
        P extends 'favouriteList' ? FavouriteListGetPayload<S['select'][P]> :  P extends keyof FavouriteEpisode ? FavouriteEpisode[P] : never
  } 
      : FavouriteEpisode


  type FavouriteEpisodeCountArgs = 
    Omit<FavouriteEpisodeFindManyArgs, 'select' | 'include'> & {
      select?: FavouriteEpisodeCountAggregateInputType | true
    }

  export interface FavouriteEpisodeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {

    /**
     * Find zero or one FavouriteEpisode that matches the filter.
     * @param {FavouriteEpisodeFindUniqueArgs} args - Arguments to find a FavouriteEpisode
     * @example
     * // Get one FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends FavouriteEpisodeFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, FavouriteEpisodeFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'FavouriteEpisode'> extends True ? Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>> : Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T> | null, null>

    /**
     * Find one FavouriteEpisode that matches the filter or throw an error  with `error.code='P2025'` 
     *     if no matches were found.
     * @param {FavouriteEpisodeFindUniqueOrThrowArgs} args - Arguments to find a FavouriteEpisode
     * @example
     * // Get one FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends FavouriteEpisodeFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, FavouriteEpisodeFindUniqueOrThrowArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Find the first FavouriteEpisode that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeFindFirstArgs} args - Arguments to find a FavouriteEpisode
     * @example
     * // Get one FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends FavouriteEpisodeFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, FavouriteEpisodeFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'FavouriteEpisode'> extends True ? Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>> : Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T> | null, null>

    /**
     * Find the first FavouriteEpisode that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeFindFirstOrThrowArgs} args - Arguments to find a FavouriteEpisode
     * @example
     * // Get one FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends FavouriteEpisodeFindFirstOrThrowArgs>(
      args?: SelectSubset<T, FavouriteEpisodeFindFirstOrThrowArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Find zero or more FavouriteEpisodes that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all FavouriteEpisodes
     * const favouriteEpisodes = await prisma.favouriteEpisode.findMany()
     * 
     * // Get first 10 FavouriteEpisodes
     * const favouriteEpisodes = await prisma.favouriteEpisode.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const favouriteEpisodeWithIdOnly = await prisma.favouriteEpisode.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends FavouriteEpisodeFindManyArgs>(
      args?: SelectSubset<T, FavouriteEpisodeFindManyArgs>
    ): Prisma.PrismaPromise<Array<FavouriteEpisodeGetPayload<T>>>

    /**
     * Create a FavouriteEpisode.
     * @param {FavouriteEpisodeCreateArgs} args - Arguments to create a FavouriteEpisode.
     * @example
     * // Create one FavouriteEpisode
     * const FavouriteEpisode = await prisma.favouriteEpisode.create({
     *   data: {
     *     // ... data to create a FavouriteEpisode
     *   }
     * })
     * 
    **/
    create<T extends FavouriteEpisodeCreateArgs>(
      args: SelectSubset<T, FavouriteEpisodeCreateArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Create many FavouriteEpisodes.
     *     @param {FavouriteEpisodeCreateManyArgs} args - Arguments to create many FavouriteEpisodes.
     *     @example
     *     // Create many FavouriteEpisodes
     *     const favouriteEpisode = await prisma.favouriteEpisode.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends FavouriteEpisodeCreateManyArgs>(
      args?: SelectSubset<T, FavouriteEpisodeCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Delete a FavouriteEpisode.
     * @param {FavouriteEpisodeDeleteArgs} args - Arguments to delete one FavouriteEpisode.
     * @example
     * // Delete one FavouriteEpisode
     * const FavouriteEpisode = await prisma.favouriteEpisode.delete({
     *   where: {
     *     // ... filter to delete one FavouriteEpisode
     *   }
     * })
     * 
    **/
    delete<T extends FavouriteEpisodeDeleteArgs>(
      args: SelectSubset<T, FavouriteEpisodeDeleteArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Update one FavouriteEpisode.
     * @param {FavouriteEpisodeUpdateArgs} args - Arguments to update one FavouriteEpisode.
     * @example
     * // Update one FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends FavouriteEpisodeUpdateArgs>(
      args: SelectSubset<T, FavouriteEpisodeUpdateArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Delete zero or more FavouriteEpisodes.
     * @param {FavouriteEpisodeDeleteManyArgs} args - Arguments to filter FavouriteEpisodes to delete.
     * @example
     * // Delete a few FavouriteEpisodes
     * const { count } = await prisma.favouriteEpisode.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends FavouriteEpisodeDeleteManyArgs>(
      args?: SelectSubset<T, FavouriteEpisodeDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Update zero or more FavouriteEpisodes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many FavouriteEpisodes
     * const favouriteEpisode = await prisma.favouriteEpisode.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends FavouriteEpisodeUpdateManyArgs>(
      args: SelectSubset<T, FavouriteEpisodeUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>

    /**
     * Create or update one FavouriteEpisode.
     * @param {FavouriteEpisodeUpsertArgs} args - Arguments to update or create a FavouriteEpisode.
     * @example
     * // Update or create a FavouriteEpisode
     * const favouriteEpisode = await prisma.favouriteEpisode.upsert({
     *   create: {
     *     // ... data to create a FavouriteEpisode
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the FavouriteEpisode we want to update
     *   }
     * })
    **/
    upsert<T extends FavouriteEpisodeUpsertArgs>(
      args: SelectSubset<T, FavouriteEpisodeUpsertArgs>
    ): Prisma__FavouriteEpisodeClient<FavouriteEpisodeGetPayload<T>>

    /**
     * Count the number of FavouriteEpisodes.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeCountArgs} args - Arguments to filter FavouriteEpisodes to count.
     * @example
     * // Count the number of FavouriteEpisodes
     * const count = await prisma.favouriteEpisode.count({
     *   where: {
     *     // ... the filter for the FavouriteEpisodes we want to count
     *   }
     * })
    **/
    count<T extends FavouriteEpisodeCountArgs>(
      args?: Subset<T, FavouriteEpisodeCountArgs>,
    ): Prisma.PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], FavouriteEpisodeCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a FavouriteEpisode.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends FavouriteEpisodeAggregateArgs>(args: Subset<T, FavouriteEpisodeAggregateArgs>): Prisma.PrismaPromise<GetFavouriteEpisodeAggregateType<T>>

    /**
     * Group by FavouriteEpisode.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FavouriteEpisodeGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends FavouriteEpisodeGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: FavouriteEpisodeGroupByArgs['orderBy'] }
        : { orderBy?: FavouriteEpisodeGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, FavouriteEpisodeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFavouriteEpisodeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>

  }

  /**
   * The delegate class that acts as a "Promise-like" for FavouriteEpisode.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FavouriteEpisodeClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  /**
   * FavouriteEpisode base type for findUnique actions
   */
  export type FavouriteEpisodeFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * Filter, which FavouriteEpisode to fetch.
     */
    where: FavouriteEpisodeWhereUniqueInput
  }

  /**
   * FavouriteEpisode findUnique
   */
  export interface FavouriteEpisodeFindUniqueArgs extends FavouriteEpisodeFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * FavouriteEpisode findUniqueOrThrow
   */
  export type FavouriteEpisodeFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
  ...
  /**
   * FavouriteEpisode base type for findFirst actions
   */
  export type FavouriteEpisodeFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for FavouriteEpisodes.
     */
    cursor?: FavouriteEpisodeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of FavouriteEpisodes.
     */
    distinct?: Enumerable<FavouriteEpisodeScalarFieldEnum>
  }

  /**
   * FavouriteEpisode findFirst
   */
  export interface FavouriteEpisodeFindFirstArgs extends FavouriteEpisodeFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  /**
   * FavouriteEpisode findFirstOrThrow
   */
  export type FavouriteEpisodeFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
  ...
  /**
   * FavouriteEpisode findMany
   */
  export type FavouriteEpisodeFindManyArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * Filter, which FavouriteEpisodes to fetch.
     */
    where?: FavouriteEpisodeWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing FavouriteEpisodes.
     */
    cursor?: FavouriteEpisodeWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
  ...
  /**
   * FavouriteEpisode create
   */
  export type FavouriteEpisodeCreateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * The data needed to create a FavouriteEpisode.
     */
    data: XOR<FavouriteEpisodeCreateInput, FavouriteEpisodeUncheckedCreateInput>
  }


  /**
   * FavouriteEpisode createMany
   */
  export type FavouriteEpisodeCreateManyArgs = {
    /**
     * The data used to create many FavouriteEpisodes.
     */
    data: Enumerable<FavouriteEpisodeCreateManyInput>
    skipDuplicates?: boolean
  }


  /**
   * FavouriteEpisode update
   */
  export type FavouriteEpisodeUpdateArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * The data needed to update a FavouriteEpisode.
     */
    data: XOR<FavouriteEpisodeUpdateInput, FavouriteEpisodeUncheckedUpdateInput>
    /**
     * Choose, which FavouriteEpisode to update.
     */
    where: FavouriteEpisodeWhereUniqueInput
  }
  ...
  /**
   * FavouriteEpisode updateMany
   */
  export type FavouriteEpisodeUpdateManyArgs = {
    /**
     * The data used to update FavouriteEpisodes.
     */
    data: XOR<FavouriteEpisodeUpdateManyMutationInput, FavouriteEpisodeUncheckedUpdateManyInput>
    /**
     * Filter which FavouriteEpisodes to update
     */
    where?: FavouriteEpisodeWhereInput
  }
  ...
  /**
   * FavouriteEpisode upsert
   */
  export type FavouriteEpisodeUpsertArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * The filter to search for the FavouriteEpisode to update in case it exists.
     */
    where: FavouriteEpisodeWhereUniqueInput
    /**
     * In case the FavouriteEpisode found by the `where` argument doesn't exist, create a new FavouriteEpisode with this data.
     */
    create: XOR<FavouriteEpisodeCreateInput, FavouriteEpisodeUncheckedCreateInput>
    /**
     * In case the FavouriteEpisode was found with the provided `where` argument, update it with this data.
     */
    update: XOR<FavouriteEpisodeUpdateInput, FavouriteEpisodeUncheckedUpdateInput>
  }


  /**
   * FavouriteEpisode delete
   */
  export type FavouriteEpisodeDeleteArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
    ...
    include?: FavouriteEpisodeInclude | null
    /**
     * Filter which FavouriteEpisode to delete.
     */
    where: FavouriteEpisodeWhereUniqueInput
  }
  ...
  /**
   * FavouriteEpisode deleteMany
   */
  export type FavouriteEpisodeDeleteManyArgs = {
    /**
     * Filter which FavouriteEpisodes to delete
     */
    where?: FavouriteEpisodeWhereInput
  }
  ...
  /**
   * FavouriteEpisode without action
   */
  export type FavouriteEpisodeArgs = {
    /**
     * Select specific fields to fetch from the FavouriteEpisode
     */
    select?: FavouriteEpisodeSelect | null
  ...
  export const FavouriteChannelScalarFieldEnum: {
    id: 'id',
    channelId: 'channelId',
    favouriteListId: 'favouriteListId'
  };

  export type FavouriteChannelScalarFieldEnum = (typeof FavouriteChannelScalarFieldEnum)[keyof typeof FavouriteChannelScalarFieldEnum]


  export const FavouriteEpisodeScalarFieldEnum: {
    id: 'id',
    episodeId: 'episodeId',
    favouriteListId: 'favouriteListId'
  };

  export type FavouriteEpisodeScalarFieldEnum = (typeof FavouriteEpisodeScalarFieldEnum)[keyof typeof FavouriteEpisodeScalarFieldEnum]
  ...
  export type UserWhereInput = {
    ...
    favouriteList?: XOR<FavouriteListRelationFilter, FavouriteListWhereInput> | null
  }
  ...
  export type UserOrderByWithRelationInput = {
    ...
    favouriteList?: FavouriteListOrderByWithRelationInput
  }
  ...
  export type ChannelWhereInput = {
    ...
    favouriteChannels?: FavouriteChannelListRelationFilter
  }
  ...
  export type ChannelOrderByWithRelationInput = {
    ...
    favouriteChannels?: FavouriteChannelOrderByRelationAggregateInput
  }
  ...
  export type EpisodeWhereInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeListRelationFilter
  }
  ...
  export type EpisodeOrderByWithRelationInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeOrderByRelationAggregateInput
  }
  ...
  export type FavouriteListWhereInput = {
    AND?: Enumerable<FavouriteListWhereInput>
    OR?: Enumerable<FavouriteListWhereInput>
    NOT?: Enumerable<FavouriteListWhereInput>
    id?: StringFilter | string
    userId?: StringFilter | string
    user?: XOR<UserRelationFilter, UserWhereInput>
    favouriteChannels?: FavouriteChannelListRelationFilter
  ...
  export type FavouriteListWhereUniqueInput = {
    id?: string
    userId?: string
  }
  ...
  export type FavouriteListScalarWhereWithAggregatesInput = {
    AND?: Enumerable<FavouriteListScalarWhereWithAggregatesInput>
    OR?: Enumerable<FavouriteListScalarWhereWithAggregatesInput>
    NOT?: Enumerable<FavouriteListScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    userId?: StringWithAggregatesFilter | string
  }

  export type FavouriteChannelWhereInput = {
    AND?: Enumerable<FavouriteChannelWhereInput>
    OR?: Enumerable<FavouriteChannelWhereInput>
    NOT?: Enumerable<FavouriteChannelWhereInput>
    id?: StringFilter | string
    channelId?: StringFilter | string
    favouriteListId?: StringFilter | string
    channel?: XOR<ChannelRelationFilter, ChannelWhereInput>
    favouriteList?: XOR<FavouriteListRelationFilter, FavouriteListWhereInput>
  }

  export type FavouriteChannelOrderByWithRelationInput = {
    id?: SortOrder
    channelId?: SortOrder
    favouriteListId?: SortOrder
    channel?: ChannelOrderByWithRelationInput
    favouriteList?: FavouriteListOrderByWithRelationInput
  }

  export type FavouriteChannelWhereUniqueInput = {
    id?: string
  }

  export type FavouriteChannelOrderByWithAggregationInput = {
    id?: SortOrder
    channelId?: SortOrder
    favouriteListId?: SortOrder
    _count?: FavouriteChannelCountOrderByAggregateInput
    _max?: FavouriteChannelMaxOrderByAggregateInput
    _min?: FavouriteChannelMinOrderByAggregateInput
  }

  export type FavouriteChannelScalarWhereWithAggregatesInput = {
    AND?: Enumerable<FavouriteChannelScalarWhereWithAggregatesInput>
    OR?: Enumerable<FavouriteChannelScalarWhereWithAggregatesInput>
    NOT?: Enumerable<FavouriteChannelScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    channelId?: StringWithAggregatesFilter | string
    favouriteListId?: StringWithAggregatesFilter | string
  }

  export type FavouriteEpisodeWhereInput = {
    AND?: Enumerable<FavouriteEpisodeWhereInput>
    OR?: Enumerable<FavouriteEpisodeWhereInput>
    NOT?: Enumerable<FavouriteEpisodeWhereInput>
    id?: StringFilter | string
    episodeId?: StringFilter | string
    favouriteListId?: StringFilter | string
    episode?: XOR<EpisodeRelationFilter, EpisodeWhereInput>
  ...
  export type FavouriteEpisodeOrderByWithRelationInput = {
    id?: SortOrder
    episodeId?: SortOrder
    favouriteListId?: SortOrder
    episode?: EpisodeOrderByWithRelationInput
  ...
  export type FavouriteEpisodeWhereUniqueInput = {
    id?: string
  }

  export type FavouriteEpisodeOrderByWithAggregationInput = {
    id?: SortOrder
    episodeId?: SortOrder
    favouriteListId?: SortOrder
    _count?: FavouriteEpisodeCountOrderByAggregateInput
    _max?: FavouriteEpisodeMaxOrderByAggregateInput
    _min?: FavouriteEpisodeMinOrderByAggregateInput
  }

  export type FavouriteEpisodeScalarWhereWithAggregatesInput = {
    AND?: Enumerable<FavouriteEpisodeScalarWhereWithAggregatesInput>
    OR?: Enumerable<FavouriteEpisodeScalarWhereWithAggregatesInput>
    NOT?: Enumerable<FavouriteEpisodeScalarWhereWithAggregatesInput>
    id?: StringWithAggregatesFilter | string
    episodeId?: StringWithAggregatesFilter | string
    favouriteListId?: StringWithAggregatesFilter | string
  }
  ...
  export type UserCreateInput = {
    ...
    favouriteList?: FavouriteListCreateNestedOneWithoutUserInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    favouriteList?: FavouriteListUncheckedCreateNestedOneWithoutUserInput
  }
  ...
  export type UserUpdateInput = {
    ...
    favouriteList?: FavouriteListUpdateOneWithoutUserNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    favouriteList?: FavouriteListUncheckedUpdateOneWithoutUserNestedInput
  }
  ...
  export type ChannelCreateInput = {
    ...
    favouriteChannels?: FavouriteChannelCreateNestedManyWithoutChannelInput
  }
  ...
  export type ChannelUncheckedCreateInput = {
    ...
    favouriteChannels?: FavouriteChannelUncheckedCreateNestedManyWithoutChannelInput
  }
  ...
  export type ChannelUpdateInput = {
    ...
    favouriteChannels?: FavouriteChannelUpdateManyWithoutChannelNestedInput
  }
  ...
  export type ChannelUncheckedUpdateInput = {
    ...
    favouriteChannels?: FavouriteChannelUncheckedUpdateManyWithoutChannelNestedInput
  }
  ...
  export type EpisodeCreateInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeCreateNestedManyWithoutEpisodeInput
  }
  ...
  export type EpisodeUncheckedCreateInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeUncheckedCreateNestedManyWithoutEpisodeInput
  }
  ...
  export type EpisodeUpdateInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeUpdateManyWithoutEpisodeNestedInput
  }
  ...
  export type EpisodeUncheckedUpdateInput = {
    ...
    favouriteEpisodes?: FavouriteEpisodeUncheckedUpdateManyWithoutEpisodeNestedInput
  }
  ...
  export type FavouriteListCreateInput = {
    ...
    favouriteChannels?: FavouriteChannelCreateNestedManyWithoutFavouriteListInput
    favouriteEpisodes?: FavouriteEpisodeCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListUncheckedCreateInput = {
    id?: string
    userId: string
    favouriteChannels?: FavouriteChannelUncheckedCreateNestedManyWithoutFavouriteListInput
    favouriteEpisodes?: FavouriteEpisodeUncheckedCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneRequiredWithoutFavouriteListNestedInput
    favouriteChannels?: FavouriteChannelUpdateManyWithoutFavouriteListNestedInput
    favouriteEpisodes?: FavouriteEpisodeUpdateManyWithoutFavouriteListNestedInput
  }

  export type FavouriteListUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    userId?: StringFieldUpdateOperationsInput | string
    favouriteChannels?: FavouriteChannelUncheckedUpdateManyWithoutFavouriteListNestedInput
    favouriteEpisodes?: FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteListNestedInput
  }
  ...
  export type FavouriteChannelCreateInput = {
    id?: string
    channel: ChannelCreateNestedOneWithoutFavouriteChannelsInput
    favouriteList: FavouriteListCreateNestedOneWithoutFavouriteChannelsInput
  }

  export type FavouriteChannelUncheckedCreateInput = {
    id?: string
    channelId: string
    favouriteListId: string
  }

  export type FavouriteChannelUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    channel?: ChannelUpdateOneRequiredWithoutFavouriteChannelsNestedInput
    favouriteList?: FavouriteListUpdateOneRequiredWithoutFavouriteChannelsNestedInput
  }

  export type FavouriteChannelUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    channelId?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteChannelCreateManyInput = {
    id?: string
    channelId: string
    favouriteListId: string
  }

  export type FavouriteChannelUpdateManyMutationInput = {
    id?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteChannelUncheckedUpdateManyInput = {
    id?: StringFieldUpdateOperationsInput | string
    channelId?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteEpisodeCreateInput = {
    id?: string
    episode: EpisodeCreateNestedOneWithoutFavouriteEpisodesInput
    favouriteList: FavouriteListCreateNestedOneWithoutFavouriteEpisodesInput
  }

  export type FavouriteEpisodeUncheckedCreateInput = {
    id?: string
    episodeId: string
    favouriteListId: string
  }

  export type FavouriteEpisodeUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    episode?: EpisodeUpdateOneRequiredWithoutFavouriteEpisodesNestedInput
    favouriteList?: FavouriteListUpdateOneRequiredWithoutFavouriteEpisodesNestedInput
  }

  export type FavouriteEpisodeUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    episodeId?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteEpisodeCreateManyInput = {
    id?: string
    episodeId: string
    favouriteListId: string
  }

  export type FavouriteEpisodeUpdateManyMutationInput = {
    id?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteEpisodeUncheckedUpdateManyInput = {
    id?: StringFieldUpdateOperationsInput | string
    episodeId?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type FavouriteListRelationFilter = {
    is?: FavouriteListWhereInput | null
    isNot?: FavouriteListWhereInput | null
  }
  ...
  export type FavouriteChannelListRelationFilter = {
    every?: FavouriteChannelWhereInput
    some?: FavouriteChannelWhereInput
    none?: FavouriteChannelWhereInput
  }
  ...
  export type FavouriteChannelOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type FavouriteEpisodeListRelationFilter = {
    every?: FavouriteEpisodeWhereInput
    some?: FavouriteEpisodeWhereInput
    none?: FavouriteEpisodeWhereInput
  }
  ...
  export type FavouriteEpisodeOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type HeartRelationFilter = {
    is?: HeartWhereInput | null
    isNot?: HeartWhereInput | null
  }
  ...
  export type FavouriteChannelCountOrderByAggregateInput = {
    id?: SortOrder
    channelId?: SortOrder
    favouriteListId?: SortOrder
  }

  export type FavouriteChannelMaxOrderByAggregateInput = {
    id?: SortOrder
    channelId?: SortOrder
    favouriteListId?: SortOrder
  }

  export type FavouriteChannelMinOrderByAggregateInput = {
    id?: SortOrder
    channelId?: SortOrder
    favouriteListId?: SortOrder
  }

  export type FavouriteEpisodeCountOrderByAggregateInput = {
    id?: SortOrder
    episodeId?: SortOrder
    favouriteListId?: SortOrder
  }

  export type FavouriteEpisodeMaxOrderByAggregateInput = {
    id?: SortOrder
    episodeId?: SortOrder
    favouriteListId?: SortOrder
  }

  export type FavouriteEpisodeMinOrderByAggregateInput = {
    id?: SortOrder
    episodeId?: SortOrder
    favouriteListId?: SortOrder
  }
  ...
  export type FavouriteListCreateNestedOneWithoutUserInput = {
    create?: XOR<FavouriteListCreateWithoutUserInput, FavouriteListUncheckedCreateWithoutUserInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutUserInput
    connect?: FavouriteListWhereUniqueInput
  }
  ...
  export type FavouriteListUncheckedCreateNestedOneWithoutUserInput = {
    create?: XOR<FavouriteListCreateWithoutUserInput, FavouriteListUncheckedCreateWithoutUserInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutUserInput
    connect?: FavouriteListWhereUniqueInput
  }
  ...
  export type FavouriteListUpdateOneWithoutUserNestedInput = {
    create?: XOR<FavouriteListCreateWithoutUserInput, FavouriteListUncheckedCreateWithoutUserInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutUserInput
    upsert?: FavouriteListUpsertWithoutUserInput
    disconnect?: boolean
    delete?: boolean
    connect?: FavouriteListWhereUniqueInput
  ...
  export type FavouriteListUncheckedUpdateOneWithoutUserNestedInput = {
    create?: XOR<FavouriteListCreateWithoutUserInput, FavouriteListUncheckedCreateWithoutUserInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutUserInput
    upsert?: FavouriteListUpsertWithoutUserInput
    disconnect?: boolean
  ...
  export type FavouriteChannelCreateNestedManyWithoutChannelInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutChannelInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutChannelInput>
    createMany?: FavouriteChannelCreateManyChannelInputEnvelope
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
  }
  ...
  export type FavouriteChannelUncheckedCreateNestedManyWithoutChannelInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutChannelInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutChannelInput>
    createMany?: FavouriteChannelCreateManyChannelInputEnvelope
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
  ...
  export type FavouriteChannelUpdateManyWithoutChannelNestedInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutChannelInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutChannelInput>
    upsert?: Enumerable<FavouriteChannelUpsertWithWhereUniqueWithoutChannelInput>
    createMany?: FavouriteChannelCreateManyChannelInputEnvelope
    set?: Enumerable<FavouriteChannelWhereUniqueInput>
    disconnect?: Enumerable<FavouriteChannelWhereUniqueInput>
    delete?: Enumerable<FavouriteChannelWhereUniqueInput>
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
    update?: Enumerable<FavouriteChannelUpdateWithWhereUniqueWithoutChannelInput>
    updateMany?: Enumerable<FavouriteChannelUpdateManyWithWhereWithoutChannelInput>
    deleteMany?: Enumerable<FavouriteChannelScalarWhereInput>
  }
  ...
  export type FavouriteChannelUncheckedUpdateManyWithoutChannelNestedInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutChannelInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutChannelInput>
    upsert?: Enumerable<FavouriteChannelUpsertWithWhereUniqueWithoutChannelInput>
    createMany?: FavouriteChannelCreateManyChannelInputEnvelope
  ...
  export type FavouriteEpisodeCreateNestedManyWithoutEpisodeInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutEpisodeInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutEpisodeInput>
    createMany?: FavouriteEpisodeCreateManyEpisodeInputEnvelope
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
  }
  ...
  export type FavouriteEpisodeUncheckedCreateNestedManyWithoutEpisodeInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutEpisodeInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutEpisodeInput>
    createMany?: FavouriteEpisodeCreateManyEpisodeInputEnvelope
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
  ...
  export type FavouriteEpisodeUpdateManyWithoutEpisodeNestedInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutEpisodeInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutEpisodeInput>
    upsert?: Enumerable<FavouriteEpisodeUpsertWithWhereUniqueWithoutEpisodeInput>
    createMany?: FavouriteEpisodeCreateManyEpisodeInputEnvelope
    set?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    disconnect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    delete?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    update?: Enumerable<FavouriteEpisodeUpdateWithWhereUniqueWithoutEpisodeInput>
    updateMany?: Enumerable<FavouriteEpisodeUpdateManyWithWhereWithoutEpisodeInput>
    deleteMany?: Enumerable<FavouriteEpisodeScalarWhereInput>
  }
  ...
  export type FavouriteEpisodeUncheckedUpdateManyWithoutEpisodeNestedInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutEpisodeInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutEpisodeInput>
    upsert?: Enumerable<FavouriteEpisodeUpsertWithWhereUniqueWithoutEpisodeInput>
    createMany?: FavouriteEpisodeCreateManyEpisodeInputEnvelope
  ...
  export type FavouriteChannelCreateNestedManyWithoutFavouriteListInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutFavouriteListInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutFavouriteListInput>
    createMany?: FavouriteChannelCreateManyFavouriteListInputEnvelope
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
  }

  export type FavouriteEpisodeCreateNestedManyWithoutFavouriteListInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutFavouriteListInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutFavouriteListInput>
    createMany?: FavouriteEpisodeCreateManyFavouriteListInputEnvelope
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
  }

  export type FavouriteChannelUncheckedCreateNestedManyWithoutFavouriteListInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutFavouriteListInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutFavouriteListInput>
    createMany?: FavouriteChannelCreateManyFavouriteListInputEnvelope
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
  ...
  export type FavouriteEpisodeUncheckedCreateNestedManyWithoutFavouriteListInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutFavouriteListInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutFavouriteListInput>
    createMany?: FavouriteEpisodeCreateManyFavouriteListInputEnvelope
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
  ...
  export type FavouriteChannelUpdateManyWithoutFavouriteListNestedInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutFavouriteListInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutFavouriteListInput>
    upsert?: Enumerable<FavouriteChannelUpsertWithWhereUniqueWithoutFavouriteListInput>
    createMany?: FavouriteChannelCreateManyFavouriteListInputEnvelope
    set?: Enumerable<FavouriteChannelWhereUniqueInput>
    disconnect?: Enumerable<FavouriteChannelWhereUniqueInput>
    delete?: Enumerable<FavouriteChannelWhereUniqueInput>
    connect?: Enumerable<FavouriteChannelWhereUniqueInput>
    update?: Enumerable<FavouriteChannelUpdateWithWhereUniqueWithoutFavouriteListInput>
    updateMany?: Enumerable<FavouriteChannelUpdateManyWithWhereWithoutFavouriteListInput>
    deleteMany?: Enumerable<FavouriteChannelScalarWhereInput>
  }

  export type FavouriteEpisodeUpdateManyWithoutFavouriteListNestedInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutFavouriteListInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutFavouriteListInput>
    upsert?: Enumerable<FavouriteEpisodeUpsertWithWhereUniqueWithoutFavouriteListInput>
    createMany?: FavouriteEpisodeCreateManyFavouriteListInputEnvelope
    set?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    disconnect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    delete?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    connect?: Enumerable<FavouriteEpisodeWhereUniqueInput>
    update?: Enumerable<FavouriteEpisodeUpdateWithWhereUniqueWithoutFavouriteListInput>
    updateMany?: Enumerable<FavouriteEpisodeUpdateManyWithWhereWithoutFavouriteListInput>
    deleteMany?: Enumerable<FavouriteEpisodeScalarWhereInput>
  }

  export type FavouriteChannelUncheckedUpdateManyWithoutFavouriteListNestedInput = {
    create?: XOR<Enumerable<FavouriteChannelCreateWithoutFavouriteListInput>, Enumerable<FavouriteChannelUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteChannelCreateOrConnectWithoutFavouriteListInput>
    upsert?: Enumerable<FavouriteChannelUpsertWithWhereUniqueWithoutFavouriteListInput>
    createMany?: FavouriteChannelCreateManyFavouriteListInputEnvelope
  ...
  export type FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteListNestedInput = {
    create?: XOR<Enumerable<FavouriteEpisodeCreateWithoutFavouriteListInput>, Enumerable<FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>>
    connectOrCreate?: Enumerable<FavouriteEpisodeCreateOrConnectWithoutFavouriteListInput>
    upsert?: Enumerable<FavouriteEpisodeUpsertWithWhereUniqueWithoutFavouriteListInput>
    createMany?: FavouriteEpisodeCreateManyFavouriteListInputEnvelope
  ...
  export type ChannelCreateNestedOneWithoutFavouriteChannelsInput = {
    create?: XOR<ChannelCreateWithoutFavouriteChannelsInput, ChannelUncheckedCreateWithoutFavouriteChannelsInput>
    connectOrCreate?: ChannelCreateOrConnectWithoutFavouriteChannelsInput
    connect?: ChannelWhereUniqueInput
  }

  export type FavouriteListCreateNestedOneWithoutFavouriteChannelsInput = {
    create?: XOR<FavouriteListCreateWithoutFavouriteChannelsInput, FavouriteListUncheckedCreateWithoutFavouriteChannelsInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutFavouriteChannelsInput
    connect?: FavouriteListWhereUniqueInput
  }

  export type ChannelUpdateOneRequiredWithoutFavouriteChannelsNestedInput = {
    create?: XOR<ChannelCreateWithoutFavouriteChannelsInput, ChannelUncheckedCreateWithoutFavouriteChannelsInput>
    connectOrCreate?: ChannelCreateOrConnectWithoutFavouriteChannelsInput
    upsert?: ChannelUpsertWithoutFavouriteChannelsInput
    connect?: ChannelWhereUniqueInput
    update?: XOR<ChannelUpdateWithoutFavouriteChannelsInput, ChannelUncheckedUpdateWithoutFavouriteChannelsInput>
  }

  export type FavouriteListUpdateOneRequiredWithoutFavouriteChannelsNestedInput = {
    create?: XOR<FavouriteListCreateWithoutFavouriteChannelsInput, FavouriteListUncheckedCreateWithoutFavouriteChannelsInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutFavouriteChannelsInput
    upsert?: FavouriteListUpsertWithoutFavouriteChannelsInput
    connect?: FavouriteListWhereUniqueInput
    update?: XOR<FavouriteListUpdateWithoutFavouriteChannelsInput, FavouriteListUncheckedUpdateWithoutFavouriteChannelsInput>
  }

  export type EpisodeCreateNestedOneWithoutFavouriteEpisodesInput = {
    create?: XOR<EpisodeCreateWithoutFavouriteEpisodesInput, EpisodeUncheckedCreateWithoutFavouriteEpisodesInput>
    connectOrCreate?: EpisodeCreateOrConnectWithoutFavouriteEpisodesInput
    connect?: EpisodeWhereUniqueInput
  }

  export type FavouriteListCreateNestedOneWithoutFavouriteEpisodesInput = {
    create?: XOR<FavouriteListCreateWithoutFavouriteEpisodesInput, FavouriteListUncheckedCreateWithoutFavouriteEpisodesInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutFavouriteEpisodesInput
    connect?: FavouriteListWhereUniqueInput
  }

  export type EpisodeUpdateOneRequiredWithoutFavouriteEpisodesNestedInput = {
    create?: XOR<EpisodeCreateWithoutFavouriteEpisodesInput, EpisodeUncheckedCreateWithoutFavouriteEpisodesInput>
    connectOrCreate?: EpisodeCreateOrConnectWithoutFavouriteEpisodesInput
    upsert?: EpisodeUpsertWithoutFavouriteEpisodesInput
    connect?: EpisodeWhereUniqueInput
    update?: XOR<EpisodeUpdateWithoutFavouriteEpisodesInput, EpisodeUncheckedUpdateWithoutFavouriteEpisodesInput>
  }

  export type FavouriteListUpdateOneRequiredWithoutFavouriteEpisodesNestedInput = {
    create?: XOR<FavouriteListCreateWithoutFavouriteEpisodesInput, FavouriteListUncheckedCreateWithoutFavouriteEpisodesInput>
    connectOrCreate?: FavouriteListCreateOrConnectWithoutFavouriteEpisodesInput
    upsert?: FavouriteListUpsertWithoutFavouriteEpisodesInput
    connect?: FavouriteListWhereUniqueInput
    update?: XOR<FavouriteListUpdateWithoutFavouriteEpisodesInput, FavouriteListUncheckedUpdateWithoutFavouriteEpisodesInput>
  }
  ...
  export type FavouriteListUpsertWithoutUserInput = {
    update: XOR<FavouriteListUpdateWithoutUserInput, FavouriteListUncheckedUpdateWithoutUserInput>
    create: XOR<FavouriteListCreateWithoutUserInput, FavouriteListUncheckedCreateWithoutUserInput>
  }
  ...
  export type FavouriteChannelCreateWithoutChannelInput = {
    id?: string
    favouriteList: FavouriteListCreateNestedOneWithoutFavouriteChannelsInput
  }

  export type FavouriteChannelUncheckedCreateWithoutChannelInput = {
    id?: string
    favouriteListId: string
  }

  export type FavouriteChannelCreateOrConnectWithoutChannelInput = {
    where: FavouriteChannelWhereUniqueInput
    create: XOR<FavouriteChannelCreateWithoutChannelInput, FavouriteChannelUncheckedCreateWithoutChannelInput>
  }

  export type FavouriteChannelCreateManyChannelInputEnvelope = {
    data: Enumerable<FavouriteChannelCreateManyChannelInput>
    skipDuplicates?: boolean
  }
  ...
  export type FavouriteChannelUpsertWithWhereUniqueWithoutChannelInput = {
    where: FavouriteChannelWhereUniqueInput
    update: XOR<FavouriteChannelUpdateWithoutChannelInput, FavouriteChannelUncheckedUpdateWithoutChannelInput>
    create: XOR<FavouriteChannelCreateWithoutChannelInput, FavouriteChannelUncheckedCreateWithoutChannelInput>
  }

  export type FavouriteChannelUpdateWithWhereUniqueWithoutChannelInput = {
    where: FavouriteChannelWhereUniqueInput
    data: XOR<FavouriteChannelUpdateWithoutChannelInput, FavouriteChannelUncheckedUpdateWithoutChannelInput>
  }

  export type FavouriteChannelUpdateManyWithWhereWithoutChannelInput = {
    where: FavouriteChannelScalarWhereInput
    data: XOR<FavouriteChannelUpdateManyMutationInput, FavouriteChannelUncheckedUpdateManyWithoutFavouriteChannelsInput>
  }

  export type FavouriteChannelScalarWhereInput = {
    AND?: Enumerable<FavouriteChannelScalarWhereInput>
    OR?: Enumerable<FavouriteChannelScalarWhereInput>
    NOT?: Enumerable<FavouriteChannelScalarWhereInput>
    id?: StringFilter | string
    channelId?: StringFilter | string
    favouriteListId?: StringFilter | string
  }
  ...
  export type FavouriteEpisodeCreateWithoutEpisodeInput = {
    id?: string
    favouriteList: FavouriteListCreateNestedOneWithoutFavouriteEpisodesInput
  }

  export type FavouriteEpisodeUncheckedCreateWithoutEpisodeInput = {
    id?: string
    favouriteListId: string
  }

  export type FavouriteEpisodeCreateOrConnectWithoutEpisodeInput = {
    where: FavouriteEpisodeWhereUniqueInput
    create: XOR<FavouriteEpisodeCreateWithoutEpisodeInput, FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>
  }

  export type FavouriteEpisodeCreateManyEpisodeInputEnvelope = {
    data: Enumerable<FavouriteEpisodeCreateManyEpisodeInput>
    skipDuplicates?: boolean
  }
  ...
  export type FavouriteEpisodeUpsertWithWhereUniqueWithoutEpisodeInput = {
    where: FavouriteEpisodeWhereUniqueInput
    update: XOR<FavouriteEpisodeUpdateWithoutEpisodeInput, FavouriteEpisodeUncheckedUpdateWithoutEpisodeInput>
    create: XOR<FavouriteEpisodeCreateWithoutEpisodeInput, FavouriteEpisodeUncheckedCreateWithoutEpisodeInput>
  }

  export type FavouriteEpisodeUpdateWithWhereUniqueWithoutEpisodeInput = {
    where: FavouriteEpisodeWhereUniqueInput
    data: XOR<FavouriteEpisodeUpdateWithoutEpisodeInput, FavouriteEpisodeUncheckedUpdateWithoutEpisodeInput>
  }

  export type FavouriteEpisodeUpdateManyWithWhereWithoutEpisodeInput = {
    where: FavouriteEpisodeScalarWhereInput
    data: XOR<FavouriteEpisodeUpdateManyMutationInput, FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteEpisodesInput>
  }

  export type FavouriteEpisodeScalarWhereInput = {
    AND?: Enumerable<FavouriteEpisodeScalarWhereInput>
    OR?: Enumerable<FavouriteEpisodeScalarWhereInput>
    NOT?: Enumerable<FavouriteEpisodeScalarWhereInput>
    id?: StringFilter | string
    episodeId?: StringFilter | string
    favouriteListId?: StringFilter | string
  }
  ...
  export type FavouriteChannelCreateWithoutFavouriteListInput = {
    id?: string
    channel: ChannelCreateNestedOneWithoutFavouriteChannelsInput
  }

  export type FavouriteChannelUncheckedCreateWithoutFavouriteListInput = {
    id?: string
    channelId: string
  }

  export type FavouriteChannelCreateOrConnectWithoutFavouriteListInput = {
    where: FavouriteChannelWhereUniqueInput
    create: XOR<FavouriteChannelCreateWithoutFavouriteListInput, FavouriteChannelUncheckedCreateWithoutFavouriteListInput>
  }

  export type FavouriteChannelCreateManyFavouriteListInputEnvelope = {
    data: Enumerable<FavouriteChannelCreateManyFavouriteListInput>
    skipDuplicates?: boolean
  }

  export type FavouriteEpisodeCreateWithoutFavouriteListInput = {
    id?: string
    episode: EpisodeCreateNestedOneWithoutFavouriteEpisodesInput
  }

  export type FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput = {
    id?: string
    episodeId: string
  }

  export type FavouriteEpisodeCreateOrConnectWithoutFavouriteListInput = {
    where: FavouriteEpisodeWhereUniqueInput
    create: XOR<FavouriteEpisodeCreateWithoutFavouriteListInput, FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>
  }

  export type FavouriteEpisodeCreateManyFavouriteListInputEnvelope = {
    data: Enumerable<FavouriteEpisodeCreateManyFavouriteListInput>
    skipDuplicates?: boolean
  }
  ...
  export type FavouriteChannelUpsertWithWhereUniqueWithoutFavouriteListInput = {
    where: FavouriteChannelWhereUniqueInput
    update: XOR<FavouriteChannelUpdateWithoutFavouriteListInput, FavouriteChannelUncheckedUpdateWithoutFavouriteListInput>
    create: XOR<FavouriteChannelCreateWithoutFavouriteListInput, FavouriteChannelUncheckedCreateWithoutFavouriteListInput>
  }

  export type FavouriteChannelUpdateWithWhereUniqueWithoutFavouriteListInput = {
    where: FavouriteChannelWhereUniqueInput
    data: XOR<FavouriteChannelUpdateWithoutFavouriteListInput, FavouriteChannelUncheckedUpdateWithoutFavouriteListInput>
  }

  export type FavouriteChannelUpdateManyWithWhereWithoutFavouriteListInput = {
    where: FavouriteChannelScalarWhereInput
    data: XOR<FavouriteChannelUpdateManyMutationInput, FavouriteChannelUncheckedUpdateManyWithoutFavouriteChannelsInput>
  }

  export type FavouriteEpisodeUpsertWithWhereUniqueWithoutFavouriteListInput = {
    where: FavouriteEpisodeWhereUniqueInput
    update: XOR<FavouriteEpisodeUpdateWithoutFavouriteListInput, FavouriteEpisodeUncheckedUpdateWithoutFavouriteListInput>
    create: XOR<FavouriteEpisodeCreateWithoutFavouriteListInput, FavouriteEpisodeUncheckedCreateWithoutFavouriteListInput>
  }

  export type FavouriteEpisodeUpdateWithWhereUniqueWithoutFavouriteListInput = {
    where: FavouriteEpisodeWhereUniqueInput
    data: XOR<FavouriteEpisodeUpdateWithoutFavouriteListInput, FavouriteEpisodeUncheckedUpdateWithoutFavouriteListInput>
  }

  export type FavouriteEpisodeUpdateManyWithWhereWithoutFavouriteListInput = {
    where: FavouriteEpisodeScalarWhereInput
    data: XOR<FavouriteEpisodeUpdateManyMutationInput, FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteEpisodesInput>
  }

  export type ChannelCreateWithoutFavouriteChannelsInput = {
    id?: string
    title: string
    publisher: string
    thumbnail: string
  ...
  export type ChannelUncheckedCreateWithoutFavouriteChannelsInput = {
    id?: string
    title: string
    publisher: string
    thumbnail: string
  ...
  export type ChannelCreateOrConnectWithoutFavouriteChannelsInput = {
    where: ChannelWhereUniqueInput
    create: XOR<ChannelCreateWithoutFavouriteChannelsInput, ChannelUncheckedCreateWithoutFavouriteChannelsInput>
  }

  export type FavouriteListCreateWithoutFavouriteChannelsInput = {
    id?: string
    user: UserCreateNestedOneWithoutFavouriteListInput
    favouriteEpisodes?: FavouriteEpisodeCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListUncheckedCreateWithoutFavouriteChannelsInput = {
    id?: string
    userId: string
    favouriteEpisodes?: FavouriteEpisodeUncheckedCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListCreateOrConnectWithoutFavouriteChannelsInput = {
    where: FavouriteListWhereUniqueInput
    create: XOR<FavouriteListCreateWithoutFavouriteChannelsInput, FavouriteListUncheckedCreateWithoutFavouriteChannelsInput>
  }

  export type ChannelUpsertWithoutFavouriteChannelsInput = {
    update: XOR<ChannelUpdateWithoutFavouriteChannelsInput, ChannelUncheckedUpdateWithoutFavouriteChannelsInput>
    create: XOR<ChannelCreateWithoutFavouriteChannelsInput, ChannelUncheckedCreateWithoutFavouriteChannelsInput>
  }

  export type ChannelUpdateWithoutFavouriteChannelsInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    publisher?: StringFieldUpdateOperationsInput | string
    thumbnail?: StringFieldUpdateOperationsInput | string
  ...
  export type ChannelUncheckedUpdateWithoutFavouriteChannelsInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    publisher?: StringFieldUpdateOperationsInput | string
    thumbnail?: StringFieldUpdateOperationsInput | string
  ...
  export type FavouriteListUpsertWithoutFavouriteChannelsInput = {
    update: XOR<FavouriteListUpdateWithoutFavouriteChannelsInput, FavouriteListUncheckedUpdateWithoutFavouriteChannelsInput>
    create: XOR<FavouriteListCreateWithoutFavouriteChannelsInput, FavouriteListUncheckedCreateWithoutFavouriteChannelsInput>
  }

  export type FavouriteListUpdateWithoutFavouriteChannelsInput = {
    id?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneRequiredWithoutFavouriteListNestedInput
    favouriteEpisodes?: FavouriteEpisodeUpdateManyWithoutFavouriteListNestedInput
  }

  export type FavouriteListUncheckedUpdateWithoutFavouriteChannelsInput = {
    id?: StringFieldUpdateOperationsInput | string
    userId?: StringFieldUpdateOperationsInput | string
    favouriteEpisodes?: FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteListNestedInput
  }

  export type EpisodeCreateWithoutFavouriteEpisodesInput = {
    id?: string
    title: string
    thumbnail: string
    channel: ChannelCreateNestedOneWithoutEpisodesInput
  ...
  export type EpisodeUncheckedCreateWithoutFavouriteEpisodesInput = {
    id?: string
    title: string
    thumbnail: string
    channelId: string
  ...
  export type EpisodeCreateOrConnectWithoutFavouriteEpisodesInput = {
    where: EpisodeWhereUniqueInput
    create: XOR<EpisodeCreateWithoutFavouriteEpisodesInput, EpisodeUncheckedCreateWithoutFavouriteEpisodesInput>
  }

  export type FavouriteListCreateWithoutFavouriteEpisodesInput = {
    id?: string
    user: UserCreateNestedOneWithoutFavouriteListInput
    favouriteChannels?: FavouriteChannelCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListUncheckedCreateWithoutFavouriteEpisodesInput = {
    id?: string
    userId: string
    favouriteChannels?: FavouriteChannelUncheckedCreateNestedManyWithoutFavouriteListInput
  }

  export type FavouriteListCreateOrConnectWithoutFavouriteEpisodesInput = {
    where: FavouriteListWhereUniqueInput
    create: XOR<FavouriteListCreateWithoutFavouriteEpisodesInput, FavouriteListUncheckedCreateWithoutFavouriteEpisodesInput>
  }

  export type EpisodeUpsertWithoutFavouriteEpisodesInput = {
    update: XOR<EpisodeUpdateWithoutFavouriteEpisodesInput, EpisodeUncheckedUpdateWithoutFavouriteEpisodesInput>
    create: XOR<EpisodeCreateWithoutFavouriteEpisodesInput, EpisodeUncheckedCreateWithoutFavouriteEpisodesInput>
  }

  export type EpisodeUpdateWithoutFavouriteEpisodesInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    thumbnail?: StringFieldUpdateOperationsInput | string
    channel?: ChannelUpdateOneRequiredWithoutEpisodesNestedInput
  ...
  export type EpisodeUncheckedUpdateWithoutFavouriteEpisodesInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    thumbnail?: StringFieldUpdateOperationsInput | string
    channelId?: StringFieldUpdateOperationsInput | string
  ...
  export type FavouriteListUpsertWithoutFavouriteEpisodesInput = {
    update: XOR<FavouriteListUpdateWithoutFavouriteEpisodesInput, FavouriteListUncheckedUpdateWithoutFavouriteEpisodesInput>
    create: XOR<FavouriteListCreateWithoutFavouriteEpisodesInput, FavouriteListUncheckedCreateWithoutFavouriteEpisodesInput>
  }

  export type FavouriteListUpdateWithoutFavouriteEpisodesInput = {
    id?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneRequiredWithoutFavouriteListNestedInput
    favouriteChannels?: FavouriteChannelUpdateManyWithoutFavouriteListNestedInput
  }

  export type FavouriteListUncheckedUpdateWithoutFavouriteEpisodesInput = {
    id?: StringFieldUpdateOperationsInput | string
    userId?: StringFieldUpdateOperationsInput | string
    favouriteChannels?: FavouriteChannelUncheckedUpdateManyWithoutFavouriteListNestedInput
  }
  ...
  export type FavouriteChannelCreateManyChannelInput = {
    id?: string
    favouriteListId: string
  }
  ...
  export type FavouriteChannelUpdateWithoutChannelInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteList?: FavouriteListUpdateOneRequiredWithoutFavouriteChannelsNestedInput
  }

  export type FavouriteChannelUncheckedUpdateWithoutChannelInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteChannelUncheckedUpdateManyWithoutFavouriteChannelsInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type FavouriteEpisodeCreateManyEpisodeInput = {
    id?: string
    favouriteListId: string
  }
  ...
  export type FavouriteEpisodeUpdateWithoutEpisodeInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteList?: FavouriteListUpdateOneRequiredWithoutFavouriteEpisodesNestedInput
  }

  export type FavouriteEpisodeUncheckedUpdateWithoutEpisodeInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteEpisodeUncheckedUpdateManyWithoutFavouriteEpisodesInput = {
    id?: StringFieldUpdateOperationsInput | string
    favouriteListId?: StringFieldUpdateOperationsInput | string
  }
  ...
  export type FavouriteChannelCreateManyFavouriteListInput = {
    id?: string
    channelId: string
  }

  export type FavouriteEpisodeCreateManyFavouriteListInput = {
    id?: string
    episodeId: string
  }

  export type FavouriteChannelUpdateWithoutFavouriteListInput = {
    id?: StringFieldUpdateOperationsInput | string
    channel?: ChannelUpdateOneRequiredWithoutFavouriteChannelsNestedInput
  }

  export type FavouriteChannelUncheckedUpdateWithoutFavouriteListInput = {
    id?: StringFieldUpdateOperationsInput | string
    channelId?: StringFieldUpdateOperationsInput | string
  }

  export type FavouriteEpisodeUpdateWithoutFavouriteListInput = {
    id?: StringFieldUpdateOperationsInput | string
    episode?: EpisodeUpdateOneRequiredWithoutFavouriteEpisodesNestedInput
  }

  export type FavouriteEpisodeUncheckedUpdateWithoutFavouriteListInput = {
    id?: StringFieldUpdateOperationsInput | string
    episodeId?: StringFieldUpdateOperationsInput | string
  }
